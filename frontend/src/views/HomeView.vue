          ...
          <div class="sheet">
            ...
            <div class="sheet__content dough">
              <label
                ...
                :key="item.id"
                :class="`dough__input dough__input--${item.class}`">
                <input
                  type="radio"
                  name="dought"
                  :value="item.value"
...
import {normalizeDough, normalizeSauces, normalizeSizes, normalizeIngredients} from '@/common/helpers/normalize';
const doughItems = doughJSON.map(normalizeDough);
const sizesItems = sizesJSON.map(normalizeSizes);
const saucesItems = saucesJSON.map(normalizeSauces);
const ingredientsItems = ingredientsJSON.map(normalizeIngredients);
